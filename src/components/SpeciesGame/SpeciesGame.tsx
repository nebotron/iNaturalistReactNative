...
const SpeciesGame = ( ) => {
  ...
  // Scans 100 random observations of taxonId from Washington state and returns all
    ...
    >
      ...
      <ScrollView className="px-4">
        {usedMisidentifications
          ? (
            <>
              <Body2 className="text-center text-darkGray pb-3">
                {`Based on 100 random observations of ${taxonLabel( target! )} from Washington state, these species were most often identified instead:`}
              </Body2>
          ...
          : (
            <Body2 className="text-center text-darkGray pb-3">
              {`No misidentification data was found in Washington state. ${taxonLabel( lookalike! )} is a related species in the same taxonomic group.`}
            </Body2>
          )}
