...
import { getPreviouslyUploadedDevicePhotoUrisSet } from "sharedHelpers/duplicateUploadedDevicePhotos";
import { normalizeDevicePhotoUri } from "sharedHelpers/getOriginalDevicePhotoUri";
import useStore from "stores/useStore";

export const getMarkedDevicePhotoUris = ( realm: Realm ): Set<string> => {
