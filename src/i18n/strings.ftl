...
# Error message when the photo the crop editor was opened for cannot be read
Could-not-open-this-photo-to-crop-it = This photo could not be opened, so there is nothing to crop.
