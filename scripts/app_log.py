...
by src/api/log/index.ts. Both reads and writes are unauthenticated, so this works
in a fresh clone with no .env; set CROP_LOG_FIREBASE_URL to read another database.
