- Always push changes directly to main as new commits. Rebase if necessary (`git pull --rebase origin main` before pushing). Never push to a feature branch unless explicitly instructed.
